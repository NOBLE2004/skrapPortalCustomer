  ...
  const columns = useMemo(
    () => [
      ...
      },
      {
        ...
        show: userData?.country_currency?.country_code === "+49"? 0 : 1,
        Cell: (props) => {
          return <>{props.row.original?.job_id == '58683' ? '16.897kg' : props.row.original?.job_id == '58486' ? '12.254kg' : props.row.original?.job_id == '58487' ? '13.113kg' : props.row.original?.job_id == '58488' ? '15.176kg' : ''}</>;
        },
      },
      {
        Header: "Weight",

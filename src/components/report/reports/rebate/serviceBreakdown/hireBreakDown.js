                    ...
                    >
                        <div className="service-box p-2">
                            <div className="service-detail">
                                <div className="percentage">Wood waste price - {currency}{sites[0] == 3629 ? 0.00 : 0.00}/ton</div>
                                <div className="percentage">Total Tonnage - 0.00 {/*(6.3 ton per skip)*/}</div>
                                {/*<div className="percentage">Number of Skips - 135</div>*/}
                                <div className="name">{currency}{sites[0] == 3629 ? '0.00' : '0.00'}</div>
                            </div>
                        </div>
                      <div className="service-box p-2">
                        <div className="service-detail">
                          <div className="percentage">Paper waste price - {currency}{sites[0] == 3629 ? 0.00 : 0.00}/ton</div>
                          <div className="percentage">Total Tonnage - 0.00 {/*(3.5 ton per skip)*/}</div>
                          {/*<div className="percentage">Number of Skips - 135</div>*/}
                          <div className="name">{currency}{sites[0] == 3629 ? '0.00' : '0.00'}</div>
                        </div>
                      </div>
                      <div className="service-box p-2">
                        <div className="service-detail">
                          <div className="percentage">Plastic waste price - {currency}{sites[0] == 3629 ? 0.00 : 0.00}/ton</div>
                          <div className="percentage">Total Tonnage - 0.00 {/*(7.0 ton per skip)*/}</div>
                          {/*<div className="percentage">Number of Skips - 135</div>*/}
                          <div className="name">{currency}{sites[0] == 3629 ? '0.00' : '0.00'}</div>
                        </div>
                      </div>

...
import UnChecked from "../../../assets/images/false.svg";
import Checked from "../../../assets/images/true.svg";

const Transition = forwardRef(function Transition(props, ref) {
  return <Fade ref={ref} {...props} />;
});

const AssignPOModal = (props) => {
                  ...
                  <FormGroup>
                    <FormControlLabel
                      ...
                      label={
                        <Typography
                          className={
                            "img-caption-address  clr-light-blue fnt-w-700"
                          }
                        >
                          #056 785 - 12 items
                        </Typography>
                    ...
                    <FormControlLabel
                      ...
                      label={
                        <Typography
                          className={"img-caption-address  clr-gray fnt-w-400"}
                        >
                          #056 786 - 4 items
                        </Typography>
                      }
